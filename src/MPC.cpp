/////////////////////// 
// Good MPC intuition video:
// https://discussions.udacity.com/t/mpc-quiz-help-needed-for-understanding/251178/28?u=sun.pochin
// https://www.youtube.com/watch?v=1nfl6OM32-4&t=523s
///////////////////////
...
// "vars" is one of many inputs of the following CppAD::ipopt::solve<Dvector, FG_eval>(
size_t x_start = 0;
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // for (size_t t = 0; t < N-1; i++) {
  //   result.push_back(solution.x[delta_start + t + 1]);
  // }
  // for (size_t t = 0; t < N-1; i++) {
  //   result.push_back(solution.x[a_start + t + 1]);
  // }
  return result;
